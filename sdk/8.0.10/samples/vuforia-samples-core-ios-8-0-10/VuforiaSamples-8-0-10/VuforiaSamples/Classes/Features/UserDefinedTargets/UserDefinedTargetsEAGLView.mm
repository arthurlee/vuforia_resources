...
namespace {
    ...
    // Model scale factor
    const float kObjectScale = .003f;
}


@interface UserDefinedTargetsEAGLView ()
...
- (id)initWithFrame:(CGRect)frame appSession:(SampleApplicationSession *)app andSampleUIUpdater:(id<SampleAppsUIControl>)sampleAppsUIControl
{
    ...
    if (self)
    {
        ...
        sampleAppRenderer = [[SampleAppRenderer alloc] initWithSampleAppRendererControl:self nearPlane:.01 farPlane:5];
